...
#define USE_GLOBAL_VAL true
    ...
    #define SERVER_SCREEN_LOGS true
        ...
        #define SUCCESS_SAVE_CREDENTIALS "[SUCCESS] Credenciales enviadas correctamente"
        ...
        #define NEW_CREDENTIALS    "[SERVER] Credenciales recibidas y guardadas correctamente"
