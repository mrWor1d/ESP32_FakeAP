...
#define USE_GLOBAL_VAL true
    ...
    #define WITH_SUCCESS_MESSAGE true
        ...
        #define ERROR_SAVE_CREDENTIALS "[ERROR] Failed to save credentials"
        #define ERROR_GENERATE_JSON "[ERROR] Failed to create JSON file"
    #endif

    #if (WITH_SUCCESS_MESSAGE)
        #define SUCCESS_SD_INIT "[SUCCESS] Tarjeta SD inicializada correctamente"
        #define SUCCESS_FILE_OPEN "[SUCCESS] El archivo: %s se ha leído correctamente. Tiempo: %.2f\n"
        #define SUCCESS_FILE_WRITE "[SUCCESS] El archivo: %s se ha guardado correctamente. Tiempo: %.2f\n"
